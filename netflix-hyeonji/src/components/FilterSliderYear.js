...
class FilterSliderYear extends React.Component {
  ...
  getYear = (time) => {
    ...
    console.log("111 time.split('')",time.split(""));
    console.log("222 time.split('').splice(0, 4)",time.split("").splice(0, 4));
    console.log("333 time.split('').splice(0, 4).join('')",time.split("").splice(0, 4).join(""));
